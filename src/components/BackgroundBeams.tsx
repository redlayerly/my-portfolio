  ...
  return (
    ...
    >
      ...
      >
        ...
        <g opacity="0.03">
          {pathData.map((d, i) => (
            <path key={`static-${i}`} d={d} stroke="#00f0ff" strokeWidth="0.5" />
          ))}
        </g>
        ...
        <defs>
          {pathData.map((_, i) => (
            ...
            >
              ...
              <stop offset="20%" stopColor="#00f0ff" stopOpacity="1" />
              <stop offset="50%" stopColor="#8b5cf6" stopOpacity="1" />
              <stop offset="80%" stopColor="#ff0055" stopOpacity="1" />
